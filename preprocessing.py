...
# import dataset
dataset = pd.read_csv('./libra_sentiment.csv')
# print(dataset.info())
...
def libra_response(sentiment):
    sentiments = json.load(open("./libra_responses.json"))['sentiments']
    # print(sentiments)
...
def testing():
    ...
    prediction_output = libra_response(sentiment)
    print(f"Libra: {prediction_output}")
